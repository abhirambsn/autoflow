...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        await websocket.send_json({ "jobId": job_id, "status": "success", "message": f"Files generated, PR is available at: {pr.html_url}" })
    except Exception as e:
        await websocket.send_json({ "jobId": job_id, "status": "error", "message": str(e) })
        raise
    finally:
